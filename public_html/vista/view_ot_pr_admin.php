...
if (!empty($_GET['id_ot'])) {
    ...
    $sql = "SELECT *,
        ...
        FROM ordenes_trabajo_pm otp WHERE id = :id_ot";
    ...
    JOIN repuestos_ot_pm rtp ON rp.id = rtp.fk_repuesto WHERE rtp.fk_ot = :idOt";
    ...
    JOIN ot_mo_pm ON mo.id = ot_mo_pm.fk_mo WHERE ot_mo_pm.fk_ot = :idOt";
